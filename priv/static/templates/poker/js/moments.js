...
require.register("js/moments/components/app.vue", function(exports, require, module) {
;(function(){
'use strict';
...
Vue.component('moments', _layout2.default);
exports.default = {
   props: ["payload"],
   data: function data() {
      return {
   ...
   created: function created() {
      console.log("moments-app created");
   }
};
})()
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cb0100a8", __vue__options__)
  } else {
    hotAPI.reload("data-v-cb0100a8", __vue__options__)
  }
})()}
});

;require.register("js/moments/components/layout.vue", function(exports, require, module) {
;(function(){
"use strict";
...
exports.default = {
	...
	data: function data() {
		return {
			visible: true,
			y: "",
			sortedItems: [{ email: "test1" }, { email: "test1" }, { email: "test1" }, { email: "test1" }, { email: "test1" }, { email: "test1" }, { email: "test1" }, { email: "test1" }]
		};
	},
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0455b722", __vue__options__)
  } else {
    hotAPI.rerender("data-v-0455b722", __vue__options__)
  }
})()}
});

;require.register("js/moments/main.js", function(exports, require, module) {
'use strict';
...
Vue.component('moments-app', _app2.default);
