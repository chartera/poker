...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'WasmExe.wast';
  var wasmBinaryFile = 'WasmExe.wasm';
  var asmjsCodeFile = 'WasmExe.temp.asm.js';
...
var real__getHand = asm["_getHand"]; asm["_getHand"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getHand.apply(null, arguments);
};
...
var _getHand = Module["_getHand"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getHand"].apply(null, arguments) };
